...
export const CLUSTER_IMAGE_QUERIES: Record<string, string[]> = {
  Tenders: ['public tender documents', 'government procurement office', 'official notice board'],
  Documentation: ['tender documentation binders', 'compliance checklist desk', 'certified documents'],
  Financing: ['bank guarantee letter', 'contract financing meeting', 'escrow documents'],
  Contractors: ['construction site meeting', 'subcontractor team', 'industrial project inspection'],
};
